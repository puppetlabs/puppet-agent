...
# This file was created by PuppetAgent for SLES 11 on zLinux (s390x).  Any
...
module RbConfig
  ...
  CONFIG["build"] = "s390x-linux-gnu"
  CONFIG["RUBY_RELEASE_DATE"] = "2015-04-13"
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.1.6"
  CONFIG["target_alias"] = "s390x-linux-gnu"
  CONFIG["host_alias"] = ""
  CONFIG["build_alias"] = "s390x-linux-gnu"
