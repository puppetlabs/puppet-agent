...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.1.0/powerpc-linux")
  ...
  CONFIG["target"] = "powerpc-unknown-linux-gnu"
  CONFIG["host_os"] = "linux-gnu"
  CONFIG["host_vendor"] = "unknown"
  CONFIG["host_cpu"] = "powerpc"
  CONFIG["host"] = "powerpc-unknown-linux-gnu"
  ...
  CONFIG["build"] = "powerpc-unknown-linux-gnu"
