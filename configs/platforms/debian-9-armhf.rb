platform "debian-9-armhf" do |plat|
  ...
  plat.provision_with "cd /etc/apt/sources.list.d/; curl -L -o armhf.list https://gist.githubusercontent.com/stahnma/c344a17f58073faa099f43a176d04330/raw/855666deb56338d6bf131c9f5e0501dcec9adcd4/gistfile1.txt; apt-get -qq update; dpkg --add-architecture armhf; cd /; curl -L -o toolchain https://gist.githubusercontent.com/stahnma/2e6066341627c00d010857619410bc18/raw/6a8f86f24a679f02a9b2d623e978e8b5665b9b50/"
