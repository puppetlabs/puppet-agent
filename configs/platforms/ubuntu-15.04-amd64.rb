platform "ubuntu-15.04-amd64" do |plat|
  ...
  plat.add_build_repository "http://pl-build-tools.delivery.puppetlabs.net/debian/pl-build-tools-release-vivid.list", "http://pl-build-tools.delivery.puppetlabs.net/debian/keyring.gpg"
