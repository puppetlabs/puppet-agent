project "puppet-agent" do |proj|
  ...
  settings[:puppet_runtime_basename] = "agent-runtime-6.0.x-#{runtime_details['version']}.#{platform.name}"
  ...
  proj.component "runtime" unless platform.name =~ /sles-15|fedora-29|el-8/
