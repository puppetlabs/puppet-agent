component "leatherman" do |pkg, settings, platform|
  ...
  elsif platform.name =~ /debian-9|el-[567]|redhatfips-7|sles-12|ubuntu-(:?16.04|18.04)/
    pkg.build_requires "pl-cmake"
    pkg.build_requires "pl-gettext"
  end

  pkg.build_requires "puppet-runtime" # Provides curl and ruby
  pkg.build_requires "runtime" if platform.name =~ /debian-9|el-[567]|redhatfips-7|sles-12|ubuntu-(:?16.04|18.04)/ ||
                                  !platform.is_linux?
