component "facter" do |pkg, settings, platform|
  ...
  pkg.build_requires 'runtime' if platform.name =~ /debian-9|el-[567]|redhatfips-7|sles-(:?11|12)|ubuntu-(:?14.04|16.04|18.04-amd64)/ ||
                                  !platform.is_linux?
  ...
  when /(debian-9|ubuntu-(15|16|18-amd64))/
  ...
  if platform.name =~ /debian-9|el-[567]|redhatfips-7|sles-(:?11|12)|ubuntu-(:?14.04|16.04|18.04-amd64)/ || !platform.is_linux?
    pkg.check do
      tests
    end
  end
